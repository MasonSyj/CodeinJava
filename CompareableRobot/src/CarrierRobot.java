public class CarrierRobot extends Robot{
    ...
    public void talk(TranslationRobot robot) {
        System.out.println(this.getName()+ " as a carrier robot is talking to another translation robot called " + robot.getName());
    }

    @Override
    public void talk(CarrierRobot robot) {
        System.out.println(this.getName()+ " as a carrier robot is talking to a carrier robot called " + robot.getName());
    }
